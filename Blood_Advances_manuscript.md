...
As an alternative to the cross-sample z-score construction, we calculated centered single-sample rank-based marker-abundance scores for platelets and the five nonplatelet lineages. Genome-wide models included response group and standardized paired changes in all five nonplatelet scores before addition of standardized rank-based platelet-score change. This was an alternative score construction using the same locked platelet markers, not an independent biological signature. Scores were interpreted as transcriptomic abundance proxies rather than calibrated cell fractions.

### Recent-IVIG exclusion and selection-independent genome-wide analysis

The paired analysis was repeated after exclusion of R7, R10, and R11, the three responders reported to have received intravenous immunoglobulin 4–8 days before pretreatment RNA collection. We also performed a selection-independent analysis using all genes with mean log2 counts per million of at least 1 and nonzero variation in paired baseline-to-week-1 change. Locked platelet-score genes were excluded. Incremental multivariate partial R2 was estimated across the complete patient-by-gene change matrix without selecting genes on the responder contrast. Because the pooled residual sum of squares weights genes according to their change variance, the analysis was repeated after scaling each gene's paired-change vector to unit standard deviation.
...
### Selection-independent analyses define the scope of the platelet-associated signal

The selection-independent analysis included 11,863 expressed, variable genes after exclusion of the locked platelet-score genes. Across this complete gene universe, platelet RNA-score change explained 16.0% of residual multivariate variation beyond response group; after each gene's paired-change vector was scaled to unit standard deviation, the corresponding estimate was 10.8%. Among 5,239 genes with a positive unadjusted responder coefficient, 34.2% showed more than 50% attenuation after platelet-score adjustment. The genome-wide responder-effect vectors before and after adjustment remained correlated (r=0.782). Thus, the platelet-associated component was concentrated in the treatment-responsive gene set rather than uniformly accounting for the full expressed transcriptome (Supplementary Figure 6).

Exclusion of R7, R10, and R11 did not attenuate the platelet RNA-score contrast. Among the remaining eight responders, the mean baseline-to-week-1 score change was 1.047, compared with -0.371 in four nonresponders, yielding a between-group difference of 1.418 (two-sided exact P=0.0524). The effect estimate was larger than in the full paired analysis, whereas precision decreased because only 12 patients remained (Supplementary Figure 6).

The alternative rank-based platelet score also increased in responders (mean change, 0.129) and decreased in nonresponders (-0.056), although the exact between-group test did not reach significance (P=0.0835). After simultaneous adjustment for rank-based erythroid, neutrophil, monocyte, T-cell, and B-cell score changes, the rank-based platelet score explained 21.3% of residual genome-wide multivariate variation. The full design matrix was well conditioned (condition number, 5.66). This sensitivity analysis supports robustness to score construction but does not provide an independent signature or estimate platelet fractions (Supplementary Figure 6).
...
The quantitative variance analysis extends this audit beyond coefficient attenuation. Platelet-score change accounted for approximately three quarters of residual multivariate variation in the overlap-free responder-induced gene set after response group was included, and the incremental effect remained large when patients were held out and gene selection was repeated within each training fold. In the selection-independent expressed-gene universe, however, the corresponding incremental partial R2 was 16.0% using the original change matrix and 10.8% after equalizing gene-wise change variance. The larger estimate is therefore specific to the treatment-responsive gene set and must not be interpreted as the proportion of all whole-blood transcriptomic variation attributable to platelets. Together, these analyses identify platelet-associated RNA as the leading measured axis within the selected treatment-responsive signal while showing that substantial genome-wide variation remains outside that axis.
...
### Supplementary Figure 6. Sensitivity to recent IVIG exposure, gene-set selection, and composition-score construction

(A) Mean paired baseline-to-week-1 platelet RNA-score changes in responders and nonresponders using all paired patients and after exclusion of R7, R10, and R11, who received intravenous immunoglobulin 4–8 days before pretreatment RNA collection. P values are two-sided exact label-permutation probabilities. (B) Selection-independent analysis of 11,863 expressed and variable genes after exclusion of locked platelet-score genes. Bars show the genome-wide incremental multivariate partial R2 from the original change matrix, the fraction of genes with positive unadjusted responder effects that showed greater than 50% attenuation, and the correlation between genome-wide responder-effect vectors before and after platelet-score adjustment. Gene-wise variance-standardized partial R2 was 0.108 and is reported in the text and source-data table. (C) Patient-level changes in an alternative centered single-sample rank-based platelet marker-abundance score constructed from the same locked platelet markers. Horizontal lines show group means. The adjusted partial R2 was estimated after simultaneous control for rank-based erythroid, neutrophil, monocyte, T-cell, and B-cell score changes. RNA scores are marker-abundance proxies and not measured cell counts or fractions.
